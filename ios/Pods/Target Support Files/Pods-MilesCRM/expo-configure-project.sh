...
with_node \
  ...
  --target "/Users/dell/Documents/miles-client/ios/Pods/Target Support Files/Pods-MilesCRM/ExpoModulesProvider.swift" \
  --entitlement "/Users/dell/Documents/miles-client/ios/MilesCRM/MilesCRM.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-background-fetch" "expo-constants" "expo-countdown-notification" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-insights" "expo-keep-awake" "expo-linking" "expo-location" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-system-ui" "expo-updates" "expo-web-browser"
